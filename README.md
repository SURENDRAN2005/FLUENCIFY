...
FLUENCIFY is a personalised training application that delivers structured, level-based stammering training using real-time speech analysis, visual biofeedback, and progressive difficulty. 

*   **D1: Web App (`/frontend`)**: Contains the React + Vite frontend with our Web Audio API pipeline, UI components, and the 7-Level progression logic. 
...
*   **D3: Backend API (`/backend`)**: Contains the FastAPI server, scoring algorithms, and dynamic exercise generation. 
